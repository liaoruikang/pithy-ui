...
export const PtArrowsTop = iconComponents[`${basespace}-arrows-top`];
export const PtArrowsBottom = iconComponents[`${basespace}-arrows-bottom`];
export const PtEye = iconComponents[`${basespace}-eye`];
export const PtCloseEye = iconComponents[`${basespace}-close-eye`];
export const PtClear = iconComponents[`${basespace}-clear`];
